...
export const featured: DenProject = {
  ...
  type: 'source',
  tier: 'gilded',
  url: 'https://github.com/Kitsune-Den/KitsuneDen',
  repo: 'https://github.com/Kitsune-Den/KitsuneDen',
...
export const projects: DenProject[] = [
  ...
  },
  {
    ...
    tier: 'azure',
    version: 'v1.0.0',
    url: 'https://github.com/Kitsune-Den/KitsunePaint',
    repo: 'https://github.com/Kitsune-Den/KitsunePaint',
  ...
  },
  {
    ...
    tier: 'gilded',
    version: 'v1.0.0',
    url: 'https://github.com/Kitsune-Den/KitsunePaintUnlocked',
    repo: 'https://github.com/Kitsune-Den/KitsunePaintUnlocked',
  ...
  },
  {
    ...
    tier: 'bronze',
    version: 'v1.0.0',
    url: 'https://github.com/Kitsune-Den/KitsuneVehicleOverhaul',
    repo: 'https://github.com/Kitsune-Den/KitsuneVehicleOverhaul',
